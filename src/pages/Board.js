...
class Board extends React.Component {
  ...
  mergeTetrominoToGrid = () => {
    ...
    this.setState(
      { grid: cleanGrid, piece: null, linesCompletes: linesCompletes, level },
      () => {
        this.makeTetromino();
        ...
        <div className="game__pan p-3">
          ...
          <div className="game-stats">
            ...
            <div className="game-stats__infos p-3">
              <p>Score: {this.state.linesCompletes}</p>
              <p>Timer: {this.state.timer}</p>
              <p>Lines: {this.state.linesCompletes}</p>
